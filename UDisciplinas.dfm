object FDisciplinas: TFDisciplinas
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Disciplinas'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSDisciplinas: TDataSource
    ...
    OnDataChange = DSDisciplinasDataChange
    Left = 136
    Top = 97
  end
  object TbDisciplinas: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbDisciplinasCODDISC: TSmallintField
      FieldName = 'CODDISC'
      Required = True
    end
    object TbDisciplinasDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 30
    end
  end
