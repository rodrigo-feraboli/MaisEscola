object FAutores: TFAutores
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Autores'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSAutores: TDataSource
    DataSet = TbAutores
    OnDataChange = DSAutoresDataChange
    Left = 136
    Top = 97
  end
  object TbAutores: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbAutoresCODAUTOR: TSmallintField
      FieldName = 'CODAUTOR'
      Required = True
    end
    object TbAutoresNOME: TMDOStringField
      FieldName = 'NOME'
      Size = 75
    end
  end
