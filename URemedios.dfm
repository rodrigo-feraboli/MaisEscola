object FRemedios: TFRemedios
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Rem'#233'dios'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TbRemedios: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbRemediosCODREMEDIO: TSmallintField
      FieldName = 'CODREMEDIO'
      Required = True
    end
    object TbRemediosDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
