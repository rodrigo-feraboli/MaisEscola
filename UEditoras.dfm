object FEditoras: TFEditoras
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Editoras'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object MainMenu1: TMainMenu
    ...
    object Relatrios1: TMenuItem
      ...
      object Sintticos1: TMenuItem
        Caption = 'Sint'#233'ticos'
        OnClick = Sintticos1Click
      end
    end
  end
  object DSEditoras: TDataSource
    DataSet = TbEditoras
    OnDataChange = DSEditorasDataChange
    Left = 136
    Top = 97
  end
  object TbEditoras: TMDODataSet
    ...
    DeleteSQL.Strings = (
      ...
      'WHERE'
      '  CODEDITORA = :OLD_CODEDITORA')
    GeneratorLink.Field = 'CODBAIRRO'
    GeneratorLink.Generator = 'GEN_BAIRROS_ID'
    InsertSQL.Strings = (
      'INSERT INTO EDITORAS'
      '  (CODEDITORA, DESCRICAO)'
      'VALUES'
      '  (:CODEDITORA, :DESCRICAO)')
    LoadDefaults = False
    ModifySQL.Strings = (
    ...
    Left = 56
    Top = 112
    object TbEditorasCODEDITORA: TSmallintField
      FieldName = 'CODEDITORA'
      Required = True
    end
    object TbEditorasDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 50
    end
  end
