object FCC: TFCC
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Centro de Custos'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSCC: TDataSource
    DataSet = TbCC
    OnDataChange = DSCCDataChange
    Left = 136
    Top = 97
  end
  object TbCC: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbCCCODCC: TSmallintField
      FieldName = 'CODCC'
      Required = True
    end
    object TbCCDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
