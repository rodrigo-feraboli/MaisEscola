object FTrat: TFTrat
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Tratamentos'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSTrat: TDataSource
    DataSet = TbTrat
    OnDataChange = DSTratDataChange
    Left = 136
    Top = 97
  end
  object TbTrat: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbTratCODTRAT: TSmallintField
      FieldName = 'CODTRAT'
      Required = True
    end
    object TbTratDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
