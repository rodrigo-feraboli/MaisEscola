...
var
  FRelatoriosSint: TFRelatoriosSint;
...
procedure TFRelatoriosSint.ParametrosRel(plCab, plDescricao: String);
begin
...
procedure TFRelatoriosSint.SBSairClick(Sender: TObject);
begin
  Close;
end;

procedure TFRelatoriosSint.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #27 then
    Close;
end;

procedure TFRelatoriosSint.FormCreate(Sender: TObject);
var
  i: smallint;
begin
  Dados.AbreConfig;
...
procedure TFRelatoriosSint.ProsseguirClick(Sender: TObject);
begin
  ...
  RLSint.Preview;
//  RvProject1.ProjectFile := 'Relatorio Generico 2.rav';
//  RvProject1.Execute;
end;

procedure TFRelatoriosSint.SpeedButton1Click(Sender: TObject);
begin
  Close;
end;
