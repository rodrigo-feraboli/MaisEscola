object FGeneros: TFGeneros
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de G'#234'neros'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSGeneros: TDataSource
    DataSet = TbGeneros
    OnDataChange = DSGenerosDataChange
    Left = 136
    Top = 97
  end
  object TbGeneros: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbGenerosCODGENERO: TSmallintField
      FieldName = 'CODGENERO'
      Required = True
    end
    object TbGenerosDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 30
    end
  end
