object FBairros: TFBairros
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Bairros'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSBairros: TDataSource
    DataSet = TbBairros
    OnDataChange = DSBairrosDataChange
    Left = 136
    Top = 97
  end
  object TbBairros: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbBairrosCODBAIRRO: TSmallintField
      FieldName = 'CODBAIRRO'
      Required = True
    end
    object TbBairrosDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
