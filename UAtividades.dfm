object FAtividades: TFAtividades
  Left = 435
  Top = 203
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Atividades'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TbAtividades: TMDODataSet
    ...
    DeleteSQL.Strings = (
      ...
      'WHERE'
      '  CODATIVIDADE = :OLD_CODATIVIDADE')
    InsertSQL.Strings = (
      'INSERT INTO ATIVIDADES'
      '  (CODATIVIDADE, DESCRICAO)'
      'VALUES'
      '  (:CODATIVIDADE, :DESCRICAO)')
    LoadDefaults = False
    ModifySQL.Strings = (
    ...
    Left = 56
    Top = 112
    object TbAtividadesCODATIVIDADE: TSmallintField
      FieldName = 'CODATIVIDADE'
      Required = True
    end
    object TbAtividadesDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 50
    end
  end
