object FDoencas: TFDoencas
  Left = 348
  Top = 195
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Doen'#231'as'
  ClientHeight = 363
  ClientWidth = 575
  Color = clSkyBlue
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Doen'#231'as'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSDoencas: TDataSource
    DataSet = TbDoencas
    OnDataChange = DSDoencasDataChange
    Left = 136
    Top = 97
  end
  object TbDoencas: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbDoencasCODDOENCA: TSmallintField
      FieldName = 'CODDOENCA'
      Required = True
    end
    object TbDoencasDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
