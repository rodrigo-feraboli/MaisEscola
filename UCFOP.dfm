object FCFOP: TFCFOP
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de CFOP'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSCFOP: TDataSource
    DataSet = TbCFOP
    OnDataChange = DSCFOPDataChange
    Left = 136
    Top = 97
  end
  object TbCFOP: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbCFOPCODCFOP: TSmallintField
      FieldName = 'CODCFOP'
      Required = True
    end
    object TbCFOPDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object TbCFOPCFOP: TMDOStringField
      FieldName = 'CFOP'
      Size = 10
    end
  end
