object FProfissoes: TFProfissoes
  Left = 461
  Top = 192
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Profiss'#245'es'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TbProfissoes: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbProfissoesCODPROFISSAO: TSmallintField
      FieldName = 'CODPROFISSAO'
      Required = True
    end
    object TbProfissoesDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object TbProfissoesVALORHORA: TMDOBCDField
      FieldName = 'VALORHORA'
      Precision = 9
      Size = 2
    end
