object FRefeicoes: TFRefeicoes
  Left = 461
  Top = 192
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Refei'#231#245'es'
  ClientHeight = 363
  ClientWidth = 575
  Color = clSkyBlue
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Refei'#231#245'es'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object DSAlim: TDataSource
    DataSet = TbRefeicoes
    OnDataChange = DSAlimDataChange
    Left = 136
    Top = 97
  end
  object TbRefeicoes: TMDODataSet
    ...
    DeleteSQL.Strings = (
      ...
      'WHERE'
      '  CODREFEICAO = :OLD_CODREFEICAO')
    InsertSQL.Strings = (
      'INSERT INTO REFEICOES'
      '  (CODREFEICAO, DESCRICAO)'
      'VALUES'
      '  (:CODREFEICAO, :DESCRICAO)')
    LoadDefaults = False
    ModifySQL.Strings = (
    ...
    Left = 56
    Top = 120
    object TbRefeicoesCODREFEICAO: TSmallintField
      FieldName = 'CODREFEICAO'
      Required = True
    end
    object TbRefeicoesDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
