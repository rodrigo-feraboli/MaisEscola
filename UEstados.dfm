object FEstados: TFEstados
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Estados'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TbEstados: TMDODataSet
    ...
    Left = 56
    Top = 112
    object TbEstadosCODESTADO: TSmallintField
      FieldName = 'CODESTADO'
      Required = True
    end
    object TbEstadosUF: TMDOStringField
      FieldName = 'UF'
      Size = 2
    end
    object TbEstadosDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 30
    end
  end
