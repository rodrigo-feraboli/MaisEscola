object FAcervoReservas: TFAcervoReservas
  Left = 242
  Top = 227
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Reservas do Acervo Liter'#225'rio'
  ClientHeight = 423
  ClientWidth = 694
  Color = clSkyBlue
  ...
  object Panel2: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object CBIni: TCheckBox
        ...
        Caption = 'Data Inicial da Reserva'
        TabOrder = 0
      end
  ...
  object QryReservas: TMDOQuery
    ...
    SQL.Strings = (
        ...
        'select AR.CODACERVO, AR.CODRESERVA, A.titulo, AR.dtreserva, F.no' +
        'me,  AL.nome,'
      'CAST('
      'case ar.status '
      'when '#39'a'#39' then '#39'Aguardando'#39
      'when '#39'c'#39' then '#39'Cancelada'#39
      'else  '#39'Conclu'#237'da'#39
      'end'
      'as VARCHAR(10)) as ST'
      'from acervoreservas AR'
    ...
    Left = 196
    Top = 291
    object QryReservasCODACERVO: TSmallintField
      FieldName = 'CODACERVO'
      Required = True
    end
    object QryReservasCODRESERVA: TSmallintField
      FieldName = 'CODRESERVA'
      Required = True
    end
    object QryReservasTITULO: TMDOStringField
      FieldName = 'TITULO'
      Size = 100
    end
    object QryReservasDTRESERVA: TDateField
      FieldName = 'DTRESERVA'
    end
    object QryReservasNOME: TMDOStringField
      FieldName = 'NOME'
      Size = 100
    end
    object QryReservasNOME1: TMDOStringField
      FieldName = 'NOME1'
      Size = 100
    end
    object QryReservasST: TMDOStringField
      FieldName = 'ST'
      Size = 10
    end
  end
  ...
  object PMReservas: TPopupMenu
    ...
    object GerarRetirada1: TMenuItem
      Caption = 'Gerar Retirada'
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object CancelarReseva1: TMenuItem
      Caption = 'Cancelar Reseva'
      OnClick = CancelarReseva1Click
    end
  end
end
