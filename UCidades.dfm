object FCidades: TFCidades
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Cidades'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TbCidades: TMDODataSet
    ...
    InsertSQL.Strings = (
      'INSERT INTO CIDADES'
      '  (CODCIDADE, CODESTADO, DESCRICAO, CEP)'
      'VALUES'
      '  (:CODCIDADE, :CODESTADO, :DESCRICAO, :CEP)')
    LoadDefaults = False
    ModifySQL.Strings = (
    ...
    Left = 56
    Top = 112
    object TbCidadesCODCIDADE: TSmallintField
      FieldName = 'CODCIDADE'
      Required = True
    end
    object TbCidadesCODESTADO: TSmallintField
      FieldName = 'CODESTADO'
    end
    object TbCidadesDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
    object TbCidadesCEP: TMDOStringField
      FieldName = 'CEP'
