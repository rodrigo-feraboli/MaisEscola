object FProdutos: TFProdutos
  ...
  object Panel1: TPanel
    ...
    object SBBusca: TSpeedButton
      ...
      Width = 59
      Height = 101
      Hint = 'Busca Avan'#231'ada de Produtos'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
  ...
  object TbProdutos: TMDODataSet
    ...
    InsertSQL.Strings = (
      'INSERT INTO PRODUTOS'
        ...
        '  (CODPROD, DESCRICAO, PRECOCOMPRA, PRECOVENDA, DATACAD, DATAULT' +
        'VENDA, '
      '   DATAULTCOMPRA, ESTATUAL, ESTMINIMO, ESTALERTA, ALUNOSADQ)'
      'VALUES'
      
        '  (:CODPROD, :DESCRICAO, :PRECOCOMPRA, :PRECOVENDA, :DATACAD, :D' +
        'ATAULTVENDA, '
    ...
    Left = 56
    Top = 112
    object TbProdutosCODPROD: TSmallintField
      FieldName = 'CODPROD'
      Required = True
    end
    object TbProdutosDESCRICAO: TMDOStringField
      FieldName = 'DESCRICAO'
      Size = 70
    end
    object TbProdutosPRECOCOMPRA: TMDOBCDField
      FieldName = 'PRECOCOMPRA'
      Precision = 9
      Size = 2
    end
    object TbProdutosPRECOVENDA: TMDOBCDField
      FieldName = 'PRECOVENDA'
      Precision = 9
      Size = 2
    end
    object TbProdutosDATACAD: TDateField
      FieldName = 'DATACAD'
      ReadOnly = True
      EditMask = '99/99/9999;1;_'
    end
    object TbProdutosDATAULTVENDA: TDateField
      FieldName = 'DATAULTVENDA'
      ReadOnly = True
      EditMask = '99/99/9999;1;_'
    end
    object TbProdutosDATAULTCOMPRA: TDateField
      FieldName = 'DATAULTCOMPRA'
      ReadOnly = True
      EditMask = '99/99/9999;1;_'
    end
    object TbProdutosESTATUAL: TMDOBCDField
      FieldName = 'ESTATUAL'
      EditFormat = '0,###.##'
      Precision = 18
      Size = 2
    end
    object TbProdutosESTMINIMO: TMDOBCDField
      FieldName = 'ESTMINIMO'
      EditFormat = '0,###.##'
      Precision = 18
      Size = 2
    end
    object TbProdutosESTALERTA: TMDOBCDField
      FieldName = 'ESTALERTA'
      Precision = 18
      Size = 2
    end
    object TbProdutosALUNOSADQ: TMDOStringField
      FieldName = 'ALUNOSADQ'
      Size = 10
    end
  end
